<script lang="ts">
	...
	function startEditing(note: { id: string; note: string }) {
	...
	<main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
		...
		<div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
			{#each [
				...
				{ name: 'Active Tasks', stat: '24', change: '+4.1%', changeType: 'increase' },
				{ name: 'Completion Rate', stat: '98.5%', change: '+1.2%', changeType: 'increase' }
			] as { name, stat, change, changeType }}
				<div class="bg-white overflow-hidden shadow rounded-lg">
					<div class="p-5">
						<div class="flex items-center">
							<div class="flex-1">
								<div class="text-sm font-medium text-gray-500 truncate">{name}</div>
...
<div class="mt-8">
	<div class="bg-white shadow rounded-lg">
		...
		<ul class="divide-y divide-gray-200">
			{#each notes as note}
				<li class="flex justify-between px-4 py-4 sm:px-6 hover:bg-gray-50">
	...
	<!-- Recent Activity -->
					...
					{#each [
						{
							...
							time: '2 hours ago',
							description: 'New features were added to the dashboard'
						},
						{
						...
						},
						{
							...
							time: '1 day ago',
							description: 'Phase 1 of Project Beta was completed'
						}
					] as activity}
		...
		<div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
			...
			<div class="bg-white shadow rounded-lg p-6">
				...
				<ul class="space-y-4">
					{#each [
						{ task: 'Project Proposal', date: 'Tomorrow', priority: 'High' },
						{ task: 'Team Meeting', date: 'In 2 days', priority: 'Medium' },
						{ task: 'Client Presentation', date: 'Next week', priority: 'High' }
					] as deadline}
